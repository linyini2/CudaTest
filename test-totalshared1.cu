...
// number of threads: 31200000, total shared memory: 18.1317G, shared memory per block: 47.5312K
...
int main(void)
{
    ...
    cout << "total shared memory: " << (double)M * BLOCK_SIZE / (1024 * 1024 * 1024) << "G" << endl;
    cout << "shared memory per block: " << (double)M * BLOCK_SIZE / (1024 * GRID_SIZE) << "K" << endl;
